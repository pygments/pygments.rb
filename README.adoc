...
This library replaces [github/albino](https://github.com/github/albino), as well as an older version of {project-name} that used an embedded Python interpreter.
